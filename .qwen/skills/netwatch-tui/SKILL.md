---
name: netwatch-tui
description: TUI ping monitor для Linux с мониторингом внешнего IP и детальной диагностикой
source: auto-skill
...
- **Внешний IP** - автоматическое определение внешнего IP с city/country информацией
